...
function findLetter(grade, id) {
    ...
    else if (8.99 >= grade && grade >= 8.5) letter = 'A';
    else if (8.49 >= grade && grade >= 8) letter = 'B+';
    else if (7.99 >= grade && grade >= 7) letter = 'B';
    else if (6.99 >= grade && grade >= 6.5) letter = 'C+';
    else if (6.49 >= grade && grade >= 5.5) letter = 'C';
    else if (5.49 >= grade && grade >= 5) letter = 'D+';
    else if (4.99 >= grade && grade >= 4) letter = 'D';
    else letter = 'F';
